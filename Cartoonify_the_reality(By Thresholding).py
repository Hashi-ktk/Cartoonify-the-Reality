...
def cartoonify(ImagePath):
    ...
    save1=Button(win,text="Save cartoon image",command=lambda: save(ReSized6, ImagePath),padx=30,pady=5)
...
def refresh():
    win.destroy()
    os.system('python "C:/Users/Hashi Ktk/Desktop/Cartoonifier/Cartoonify_the_reality(By Thresholding).py"')
